...
class DAClassifierDataset(data.Dataset):

    def __init__(self, opt):
        super(DAClassifierDataset, self).__init__()
        self.opt = opt
        ...
        self.kernel_range = [2 * v + 1 for v in range(math.ceil(self.blur_kernel_size_minimum_standard1 / 2), math.ceil(self.blur_kernel_size_standard1 / 2))]
