...
from basicsr.models.srgan_dynamic_pred_model import SRGANPredModel
...
class DASRPredModel(SRGANPredModel):

    def __init__(self, opt):
        super(DASRPredModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DASRPredModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
