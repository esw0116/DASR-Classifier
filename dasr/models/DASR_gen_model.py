...
from basicsr.models.srgan_dynamic_gen_model import SRGANGenModel
...
class DASRGenModel(SRGANGenModel):

    def __init__(self, opt):
        super(DASRGenModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DASRGenModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
