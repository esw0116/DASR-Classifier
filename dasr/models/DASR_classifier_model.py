...
from basicsr.models.srgan_classify_model import SRGANClassifyModel
...
class DASRClassifierModel(SRGANClassifyModel):

    def __init__(self, opt):
        super(DASRClassifierModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DASRClassifierModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
