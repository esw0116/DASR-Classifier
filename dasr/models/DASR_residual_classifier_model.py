...
from basicsr.models.srgan_residual_classify_model import SRGANReidualClassifyModel
...
class DASRResidualClassifierModel(SRGANReidualClassifyModel):

    def __init__(self, opt):
        super(DASRResidualClassifierModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DASRResidualClassifierModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
