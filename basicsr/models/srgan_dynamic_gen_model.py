...
class SRGANGenModel(BaseModel):
    """Base SR model for single image super-resolution."""

    def __init__(self, opt):
        super(SRGANGenModel, self).__init__(opt)
    ...
    def feed_data(self, data):
        assert 'degradation_params' in data.keys()
    ...
    def optimize_parameters(self, current_iter):
        ...
        weights = self.net_p.forward_mappingnet(self.degradation_params)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            if save_img:
                ...
                # savetensor(self.predicted_params.cpu(), save_tensor_path)
        ...
        if with_metrics:
            for metric in self.metric_results.keys():
                ...
                logger = get_root_logger()
                logger.info(f'{metric}/{self.metric_results[metric]}')
