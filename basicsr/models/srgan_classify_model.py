...
class SRGANClassifyModel(BaseModel):
    """Base SR model for single image super-resolution."""

    def __init__(self, opt):
        super(SRGANClassifyModel, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter):
        ...
        out_params1, out_params2, out_params3 = self.net_p(self.lq)
    ...
    def test(self):
        self.net_p.eval()
        with torch.no_grad():
            pred_prob1, pred_prob2, pred_prob3 = self.net_p(self.lq)
